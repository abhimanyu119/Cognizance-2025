      ...
      <section className="features" id="features">
        ...
        <div className="feature-grid">
          ...
          <div className="feature-card">
            ...
            <p>Track your earnings, project completion rates, and client satisfaction scores to continually improve your freelance business.</p>
          </div>
        </div>
      </section>
        ...
        <div className="steps-container">
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>Set up your web development project with detailed scope, timeline, and milestones. Invite your client to join the platform.</p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>Your client funds a secure escrow account for the project or milestone. Funds are held safely until work is completed and approved.</p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>Use our built-in time tracking and progress reporting tools to document your work. Updates are shared automatically with your client.</p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>Once milestones are approved, payment is automatically released from escrow to your preferred payment method within 24 hours.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="pricing" id="pricing">
        ...
        <div className="pricing-grid">
          ...
          <div className="pricing-card">
            ...
            <button className="cta-button" onClick={showContactToast}>Contact Sales</button>
          </div>
        </div>
      </section>
      ...
      <style jsx>{`
        ...
        * {
        ...
        .hero {
            ...
            align-items: center;
            padding: 8rem 5% 5rem;
            background: linear-gradient(135deg, rgba(15, 23, 42, 0.9) 0%, rgba(11, 17, 32, 0.9) 100%), url('/api/placeholder/1920/1080') center/cover;
            position: relative;
            overflow: hidden;
        }
        ...
        .hero::before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 70% 30%, rgba(62, 219, 211, 0.15) 0%, transparent 70%);
        }
        ...
        .hero h1 {
            ...
            letter-spacing: -1px;
            font-weight: 700;
            background: linear-gradient(90deg, var(--light-text) 0%, var(--primary) 100%);
        ...
        .features::before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 20% 80%, rgba(74, 123, 247, 0.1) 0%, transparent 70%);
        }
        ...
        .how-it-works::before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 80% 40%, rgba(255, 110, 199, 0.1) 0%, transparent 70%);
        }
        ...
        .testimonials::before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 20% 30%, rgba(62, 219, 211, 0.1) 0%, transparent 70%);
        }
        ...
        .pricing::before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 80% 80%, rgba(74, 123, 247, 0.1) 0%, transparent 70%);
        }
